...
class DecadesProtocol(basic.LineReceiver):
   ...
   def rawDataReceived(self, data):
      ...
      if data[0:4] == "PARA":
         ...
         547:"fwvs_humidity_mixing_ratio",
         548:"angle_of_attack",
         ...
         565:"ins_pitch_rate",
         566:"ins_yaw_rate",
         567:"northwards_wind_component",
         568:"eastwards_wind_component",
         ...
         580:"solar_albedo",
         581:"near_infra-red_albedo",
         582:"visible_albedo",
         583:"lower_visible_flux",
         584:"upper_visible_flux",
         585:"net_infra-red_flux",
         586:"upper_near_infra-red_fraction",
         587:"lower_near_infra-red_fraction",
         588:"co_mixing_ratio",
         589:"refractivity",
         590:"corrected_surface_temp",
         591:"dew_point_(total_water)",
