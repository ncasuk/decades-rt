...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.pngmath', 'sphinx.ext.napoleon']
...
versionelements = versionfile.read().strip().split('.')
version = '.'.join(versionelements[0:2])
# The full version, including alpha/beta/rc tags.
release = '.'.join(versionelements)
...
# of the sidebar.
html_logo = html_static_path[0] + '/FAAM.svg'
